                    ...
                    <div className="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
                        <div className="col-lg-9">
                            ...
                            <ul className="faq-list">
                                ...
                                <li>
                                    <div data-bs-toggle="collapse" className="collapsed question" href="#faq1">What is the Blackhole Explorations Conference about?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                                ...
                                <li>
                                    <div data-bs-toggle="collapse" href="#faq2" className="collapsed question">How can I register for the conference?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                                ...
                                <li>
                                    <div data-bs-toggle="collapse" href="#faq3" className="collapsed question">Are there any discounts available for the conference?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                                ...
                                <li>
                                    <div data-bs-toggle="collapse" href="#faq4" className="collapsed question">Will the conference sessions be available for live streaming?<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                                ...
                                <li>
                                    <div data-bs-toggle="collapse" href="#faq5" className="collapsed question">Which companies will be showcasing their technologies at the conference? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                                ...
                                <li>
                                    <div data-bs-toggle="collapse" href="#faq6" className="collapsed question">How can I submit my research paper for the conference? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
